...
美瑛町民スキー場 LP（`docs/mock-assets/biei-lp/`）を、**海外 FIT 旅行者のフック**として機能させる。  
...
- **画像**: Gemini 生成の冬ライトアップ（人物なし・実写風）
  - `lp-mock-biei-blue-pond-hero.png` — 詳細 Hero / Featured 16:9
  - `lp-mock-biei-blue-pond-thumb.png` — Guides サムネ 4:5
...
| 環境 | URL |
|------|-----|
| ローカル | `http://localhost:3456/biei-lp/index.html` |
| 本番 | `https://guides.japowserch.com/biei/blue-pond.html` |
| EN | `?lang=en` |
...
- [x] `guides/scripts/sync.mjs` で `/biei/blue-pond.html` 配信確認
