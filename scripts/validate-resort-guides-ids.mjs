...
const NAME_SUBSTRINGS = {
  ...
  furano: ["富良野スキー場", "富良野"],
  canmore: ["キャンモア"],
  "santa-present-park": ["サンタプレゼント", "マロース"],
  sichinohe: ["七戸"],
  tsunan: ["津南"],
  kirigamine: ["霧ヶ峰", "霧ケ峰"],
  ...
  okoppe: ["興部町営", "興部"],
  shirataka: ["白鷹町営", "白鷹"],
  "nishiwaigawa-yuda": ["西和賀町営湯田", "湯田"],
  "nakafuranokita-hoshi": ["中富良野北星", "北星"],
  ...
  shimokawa: ["下川"],
  "shizenkoen-swiss": ["森林公園スイス村", "スイス村"],
  "muroran-danpara": ["室蘭市だんパラ", "だんパラ"],
  akenogaoka: ["明野ヶ丘", "明野"],
  "rubeshibe-happodai": ["留辺蘂町八方台", "八方台"],
  usazawa: ["兎沢"],
  ohotakedake: ["於法岳"],
  akiyama: ["秋山"],
  kujuo: ["莇生田"],
  "nakagawa-town": ["中川町民"],
  kanegasawa: ["金ヶ沢"],
  "midori-roman-mori": ["みどりの大地とロマンの森公園"],
  "kotori-yama": ["小鳥山"],
  tenoko: ["手ノ子"],
  "asahi-prime": ["あさひプライム"],
  oide: ["小出"],
  "tajima-bokujo": ["但馬牧場公園"],
  "miino-no-hara": ["三井野原"],
  horotachi: ["ほろたち", "幌加内"],
  kurodake: ["黒岳", "大雪山黒岳"],
  "appi-kogen": ["安比高原", "安比"],
  "iwate-kogen-snow-park": ["岩手高原", "スノーパーク"],
  shizukuishi: ["雫石"],
  "hakuba-happo-one": ["八方尾根", "白馬八方"],
  "hakuba-goryu": ["五竜", "白馬五竜"],
  "shiga-kogen": ["ジャイアント", "志賀"],
  togakushi: ["戸隠"],
  "madarao-kogen": ["斑尾"],
  "nozawa-onsen": ["野沢温泉", "野沢"],
  togakushi: ["戸隠"],
  "gala-yuzawa": ["GALA", "ガーラ"],
  kandatsu: ["神立"],
  "ishiuchi-maruyama": ["石打丸山", "石打"],
  iwappara: ["岩原"],
  maiko: ["舞子"],
  naeba: ["苗場"],
  kagura: ["かぐら", "神楽"],
